                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <a className="nav-link active" href="page1">Page1</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" href="page2">Page2</a>
                            </li>

                            <li className="nav-item">
                                <a className="nav-link active" href="page3">Page3</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" href="page4">Page4</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" href="page5">Page5</a>
                            </li>
